...
#Region "Function"
    ...
    Public Function SAVE() As Integer
        ...
        Try
            ...
            Dim strCommand As String = "SP_MASTER_PLANMASTER_SAVE"
    ...
    Public Function update() As Integer
        ...
        Try
            ...
            'save gradeMaster
            Dim strCommand As String = "SP_MASTER_PLANMASTER_UPDATE"
            Dim alParameter As New ArrayList
            With alParameter
    ...
    Public Function DELETE() As DataTable
        ...
        Try
            ...
            'save gradeMaster
            Dim strCommand As String = "SP_MASTER_PLANMASTER_DELETE"
            Dim alParameter As New ArrayList
            With alParameter

                .Add(New SqlClient.SqlParameter("@PLANNAME", alParaval(0)))
