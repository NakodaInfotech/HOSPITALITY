...
Public Class ClsEXCLUSIONMaster
...
#Region "Function"
    ...
    Public Function SAVE() As Integer
        ...
        Try
            ...
            Dim strCommand As String = "SP_MASTER_EXCLUSIONMASTER_SAVE"
    ...
    Public Function update() As Integer
        ...
        Try
            ...
            'save gradeMaster
            Dim strCommand As String = "SP_MASTER_EXCLUSIONMASTER_UPDATE"
            Dim alParameter As New ArrayList
            With alParameter
                ...
                .Add(New SqlClient.SqlParameter("@yearid", alParaval(5)))
                .Add(New SqlClient.SqlParameter("@transfer", alParaval(6)))
                .Add(New SqlClient.SqlParameter("@EXCLUSIONID", alParaval(7)))
    ...
    Public Function DELETE() As DataTable
        ...
        Try
            ...
            'save gradeMaster
            Dim strCommand As String = "SP_MASTER_EXCLUSIONMASTER_DELETE"
            Dim alParameter As New ArrayList
            With alParameter

                .Add(New SqlClient.SqlParameter("@EXCLUSIONID", alParaval(0)))
