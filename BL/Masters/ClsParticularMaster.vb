Imports DB
Public Class ClsParticularMaster
...
#Region "Function"
    ...
    Public Function save() As Integer
        ...
        Try
            ...
            'save CategoryMaster
            Dim strCommand As String = "SP_MASTER_PARTICULARMASTER_SAVE"
            Dim alParameter As New ArrayList
            With alParameter

                .Add(New SqlClient.SqlParameter("@particularname", alParaval(0)))
                .Add(New SqlClient.SqlParameter("@particularremarks", alParaval(1)))
    ...
    Public Function Update() As Integer
        ...
        Try
            ...
            'save CategoryMaster
            Dim strCommand As String = "SP_MASTER_PARTICULARMASTER_UPDATE"
            Dim alParameter As New ArrayList
            With alParameter
