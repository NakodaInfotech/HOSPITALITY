...
#Region "Function"
    ...
    Public Function SAVE() As Integer
        ...
        Try
            ...
            Dim strCommand As String = "SP_MASTER_PREFIXMASTER_SAVE"
    ...
    Public Function update() As Integer
        ...
        Try
            ...
            'save gradeMaster
            Dim strCommand As String = "SP_MASTER_PREFIXMASTER_UPDATE"
            Dim alParameter As New ArrayList
            With alParameter
                ...
                .Add(New SqlClient.SqlParameter("@yearid", alParaval(5)))
                .Add(New SqlClient.SqlParameter("@transfer", alParaval(6)))
                .Add(New SqlClient.SqlParameter("@PREFIXID", alParaval(7)))
    ...
    Public Function DELETE() As Integer
        ...
        Try
            ...
            'save gradeMaster
            Dim strCommand As String = "SP_MASTER_PREFIXMASTER_DELETE"
            Dim alParameter As New ArrayList
            With alParameter
