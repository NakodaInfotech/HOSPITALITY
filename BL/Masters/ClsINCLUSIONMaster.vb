Imports DB
Public Class ClsINCLUSIONMaster
...
#Region "Function"
    ...
    Public Function SAVE() As Integer
        ...
        Try
            ...
            Dim strCommand As String = "SP_MASTER_INCLUSIONMASTER_SAVE"
    ...
    Public Function update() As Integer
        ...
        Try
            ...
            'save gradeMaster
            Dim strCommand As String = "SP_MASTER_INCLUSIONMASTER_UPDATE"
            Dim alParameter As New ArrayList
            With alParameter
                ...
                .Add(New SqlClient.SqlParameter("@yearid", alParaval(5)))
                .Add(New SqlClient.SqlParameter("@transfer", alParaval(6)))
                .Add(New SqlClient.SqlParameter("@INCLUSIONID", alParaval(7)))
    ...
    Public Function DELETE() As DataTable
        ...
        Try
            ...
            'save gradeMaster
            Dim strCommand As String = "SP_MASTER_INCLUSIONMASTER_DELETE"
            Dim alParameter As New ArrayList
            With alParameter

                .Add(New SqlClient.SqlParameter("@INCLUSIONID", alParaval(0)))
