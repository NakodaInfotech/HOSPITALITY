...
#Region "Functions"
    ...
    Public Function getSUMMARY() As DataTable
        ...
        Try
            ...
            With alParameter
                ...
                .Add(New SqlClient.SqlParameter("@CHECKARR", alParaval(3)))
                .Add(New SqlClient.SqlParameter("@ARRFROM", alParaval(4)))
                .Add(New SqlClient.SqlParameter("@ARRTO", alParaval(5)))
    ...
    Public Function LEDGERSUMMARYHOMEPAGE() As DataTable
        Dim DT As DataTable
        Try
            'get data from register
            Dim strCommand As String = "SP_REPORTS_ACCOUNTS_LEDGERSUMMARY_SUMMARYHOMEPAGE"
            Dim alParameter As New ArrayList
            With alParameter
