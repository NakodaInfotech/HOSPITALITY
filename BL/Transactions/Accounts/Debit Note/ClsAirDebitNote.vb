...
#Region "Functions"
    ...
    Public Function save() As DataTable
        ...
        Try
            'save CREDITNOTE
            Dim strCommand As String = "SP_TRANS_AIRDEBITNOTE_SAVE"
    ...
    Public Function SELECTDEBITNOTE_EDIT(ByVal DNNO As Integer, ByVal REGISTERNAME As String, ByVal CMPID As Integer, ByVal LOCATIONID As Integer, ByVal YEARID As Integer) As DataTable
        ...
        Try
            ...
            Dim strCommand As String = "SP_TRANS_SELECT_AIRDEBITNOTE_FOR_EDIT"
            Dim alParameter As New ArrayList
            With alParameter
    ...
    Public Function update() As DataTable
        ...
        Try
            ...
            Dim strCommand As String = "SP_TRANS_AIRDEBITNOTE_UPDATE"
            Dim alParameter As New ArrayList
            With alParameter
    ...
    Public Function Delete() As DataTable
        Dim dtTable As DataTable
        Try
            Dim strCommand As String = "SP_TRANS_AIRDEBITNOTE_DELETE"
            Dim alParameter As New ArrayList
            With alParameter
