...
Public Class ClsInternationalBooking
...
#Region "Functions"
    ...
    Public Function save() As DataTable
        ...
        Try
            ...
            Dim strCommand As String = "SP_TRANS_BOOKING_INTERNATIONALBOOKING_SAVE"
    ...
    Public Function SAVEAMENDEDBOOKING() As DataTable
        ...
        Try
            ...
            Dim strCommand As String = "SP_TRANS_BOOKING_INTERNATIONALBOOKING_SAVE_AMENDED"
            Dim alParameter As New ArrayList
            With alParameter
    ...
    Public Function SELECTBOOKINGFORAMEND() As DataTable
        ...
        Try
            ...
            Dim strCommand As String = "SP_TRANS_SELECT_INTERNATIONALBOOKING_FOR_AMENDMENT"
            Dim alParameter As New ArrayList
            With alParameter
    ...
    Public Function SELECTBOOKINGDESC() As DataTable
        ...
        Try
            ...
            Dim strCommand As String = "SP_TRANS_SELECT_INTERNATIONALBOOKINGDESC_FOR_EDIT"
            Dim alParameter As New ArrayList
            With alParameter
    ...
    Public Function SELECTBOOKINGGUESTDETAILS() As DataTable
        ...
        Try
            ...
            Dim strCommand As String = "SP_TRANS_SELECT_INTERNATIONALBOOKINGGUESTDETAILS_FOR_EDIT"
            Dim alParameter As New ArrayList
            With alParameter
                .Add(New SqlClient.SqlParameter("@BOOKINGNO", alParaval(0)))
                .Add(New SqlClient.SqlParameter("@CMPID", alParaval(1)))
    ...
    Public Function SELECTBOOKINGTOURDETAILS() As DataTable
        ...
        Try
            ...
            Dim strCommand As String = "SP_TRANS_SELECT_INTERNATIONALBOOKINGTOURDETAILS_FOR_EDIT"
            Dim alParameter As New ArrayList
            With alParameter
                .Add(New SqlClient.SqlParameter("@BOOKINGNO", alParaval(0)))
                .Add(New SqlClient.SqlParameter("@CMPID", alParaval(1)))
    ...
    Public Function SELECTBOOKINGTRANSDETAILS() As DataTable
        ...
        Try
            ...
            Dim strCommand As String = "SP_TRANS_SELECT_INTERNATIONALBOOKINGTRANSDETAILS_FOR_EDIT"
            Dim alParameter As New ArrayList
            With alParameter
                .Add(New SqlClient.SqlParameter("@BOOKINGNO", alParaval(0)))
                .Add(New SqlClient.SqlParameter("@CMPID", alParaval(1)))
    ...
    Public Function SELECTBOOKINGPURDETAILS() As DataTable
        ...
        Try
            ...
            Dim strCommand As String = "SP_TRANS_SELECT_INTERNATIONALBOOKINGPURDETAILS_FOR_EDIT"
            Dim alParameter As New ArrayList
            With alParameter
                .Add(New SqlClient.SqlParameter("@BOOKINGNO", alParaval(0)))
                .Add(New SqlClient.SqlParameter("@CMPID", alParaval(1)))
    ...
    Public Function update() As Integer
        ...
        Try
            ...
            Dim strCommand As String = "SP_TRANS_BOOKING_INTERNATIONALBOOKING_UPDATE"
            Dim alParameter As New ArrayList
            With alParameter
    ...
    Public Function CANCEL() As Integer
        Dim INTRESULT As Integer
        Try
            Dim strCommand As String = "SP_TRANS_BOOKING_INTERNATIONALBOOKING_CANCEL"
            Dim alParameter As New ArrayList
            With alParameter
                .Add(New SqlClient.SqlParameter("@BOOKINGNO", alParaval(0)))
                .Add(New SqlClient.SqlParameter("@Cmpid", alParaval(1)))
    ...
    Public Function Delete() As DataTable
        Dim DTTABLE As DataTable
        Try
            Dim strCommand As String = "SP_TRANS_BOOKING_INTERNATIONALBOOKING_DELETE"
            Dim alParameter As New ArrayList
            With alParameter
                .Add(New SqlClient.SqlParameter("@BOOKINGNO", alParaval(0)))
                .Add(New SqlClient.SqlParameter("@Cmpid", alParaval(1)))
