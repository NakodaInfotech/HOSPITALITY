...
Public Class ClsAirlineBookingMaster
...
#Region "Functions"
    ...
    Public Function save() As DataTable
        ...
        Try
            ...
            strCommand = "SP_TRANS_BOOKING_AIRLINEBOOKING_SAVE"
    ...
    Public Function SELECTBOOKING() As DataTable
        ...
        Try
            ...
            Dim strCommand As String = "SP_TRANS_SELECT_AIRLINEBOOKING_FOR_EDIT"
            Dim alParameter As New ArrayList
            With alParameter
                .Add(New SqlClient.SqlParameter("@BOOKINGNO", alParaval(0)))
                .Add(New SqlClient.SqlParameter("@REGID", alParaval(1)))
    ...
    Public Function UPDATE() As DataTable
        ...
        Try
            ...
            strCommand = "SP_TRANS_BOOKING_AIRLINEBOOKING_UPDATE"
            Dim alParameter As New ArrayList
            With alParameter
    ...
    Public Function SAVEQRCODE() As Integer
        ...
        Try
            'save SALE order
            Dim strCommand As String = "SP_TRANS_BOOKING_AIRLINEBOOKING_QRCODE"
            Dim alParameter As New ArrayList
            With alParameter
    ...
    Public Function CANCEL() As Integer
        Dim INTRESULT As Integer
        Try
            Dim strCommand As String = "SP_TRANS_BOOKING_AIRLINEBOOKING_CANCEL"
            Dim alParameter As New ArrayList
            With alParameter
                .Add(New SqlClient.SqlParameter("@BOOKINGNO", alParaval(0)))
    ...
    Public Function Delete() As DataTable
        Dim DTTABLE As DataTable
        Try
            Dim strCommand As String = "SP_TRANS_BOOKING_AIRLINEBOOKING_DELETE"
            Dim alParameter As New ArrayList
            With alParameter
