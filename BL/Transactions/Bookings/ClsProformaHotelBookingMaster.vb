Imports DB
Public Class ClsProformaHotelBookingMaster
...
#Region "Functions"
    ...
    Public Function save() As DataTable
        ...
        Try
            ...
            If alParaval(0) = "BOOKING" Then
                strCommand = "SP_TRANS_BOOKING_PROFORMAHOTELBOOKING_SAVE"
            ElseIf alParaval(0) = "TRANSFER" Then
                strCommand = "SP_TRANS_BOOKING_PROFORMAHOTELBOOKING_TRANSFER_SAVE"
            End If
    ...
    Public Function SAVEAMENDEDBOOKING() As DataTable
        ...
        Try
            ...
            If alParaval(0) = "BOOKING" Then
                strCommand = "SP_TRANS_BOOKING_PROFORMAHOTELBOOKING_SAVE_AMENDED"
            ElseIf alParaval(0) = "TRANSFER" Then
                strCommand = "SP_TRANS_BOOKING_PROFORMAHOTELBOOKING_TRANSFER_SAVE_AMENDED"
            End If
            Dim alParameter As New ArrayList
            With alParameter
    ...
    Public Function SELECTBOOKINGFORAMEND() As DataTable
        ...
        Try
            ...
            Dim strCommand As String = "SP_TRANS_SELECT_PROFORMAHOTELBOOKING_FOR_AMENDMENT"
            Dim alParameter As New ArrayList
            With alParameter
    ...
    Public Function SELECTBOOKING() As DataTable
        ...
        Try
            ...
            Dim strCommand As String = "SP_TRANS_SELECT_PROFORMAHOTELBOOKING_FOR_EDIT"
            Dim alParameter As New ArrayList
            With alParameter
                .Add(New SqlClient.SqlParameter("@TYPE", alParaval(0)))
    ...
    Public Function update() As Integer
        ...
        Try
            ...
            If alParaval(0) = "BOOKING" Then
                strCommand = "SP_TRANS_BOOKING_PROFORMAHOTELBOOKING_UPDATE"
            ElseIf alParaval(0) = "TRANSFER" Then
                strCommand = "SP_TRANS_BOOKING_PROFORMAHOTELBOOKING_TRANSFER_UPDATE"
            End If
            Dim alParameter As New ArrayList
            With alParameter
    ...
    Public Function CANCEL() As Integer
        Dim INTRESULT As Integer
        Try
            Dim strCommand As String = "SP_TRANS_BOOKING_POFORMAHOTELBOOKING_CANCEL"
            Dim alParameter As New ArrayList
            With alParameter
                .Add(New SqlClient.SqlParameter("@TYPE", alParaval(0)))
                .Add(New SqlClient.SqlParameter("@BOOKINGNO", alParaval(1)))
    ...
    Public Function Delete() As DataTable
        Dim DTTABLE As DataTable
        Try
            Dim strCommand As String = "SP_TRANS_BOOKING_PROFORMAHOTELBOOKING_DELETE"
            Dim alParameter As New ArrayList
            With alParameter
                .Add(New SqlClient.SqlParameter("@TYPE", alParaval(0)))
                .Add(New SqlClient.SqlParameter("@BOOKINGNO", alParaval(1)))
