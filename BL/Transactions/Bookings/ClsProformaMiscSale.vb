...
Public Class ClsProformaMiscSale
...
#Region "Functions"
    ...
    Public Function SELECTBOOKING() As DataTable
        ...
        Try
            ...
            Dim strCommand As String = "SP_TRANS_SELECT_PROFROMAMISCSALBOOKING_FOR_EDIT"
    ...
    Public Function SAVE() As DataTable
        ...
        Try
            ...
            strCommand = "SP_TRANS_BOOKING_PROFORMAMISC_SAL_SAVE"
    ...
    Public Function UPDATE() As Integer
        ...
        Try
            ...
            strCommand = "SP_TRANS_BOOKING_PROFORMAMISC_SAL_UPDATE"
    ...
    Public Function CANCEL() As Integer
        Dim INTRESULT As Integer
        Try
            Dim strCommand As String = "SP_TRANS_BOOKING_PROFORMAMISC_SAL_CANCEL"
            Dim alParameter As New ArrayList
            With alParameter
    ...
    Public Function Delete() As DataTable
        Dim DTTABLE As DataTable
        Try
            Dim strCommand As String = "SP_TRANS_BOOKING_PROFORMAMISC_SAL_DELETE"
            Dim alParameter As New ArrayList
            With alParameter
                .Add(New SqlClient.SqlParameter("@BOOKINGNO", alParaval(0)))
                .Add(New SqlClient.SqlParameter("@REGISTER", alParaval(1)))
