...
Public Class BankReco
    ...
    Private Sub TOOLUPLOAD_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles TOOLUPLOAD.Click
        ...
        If OBJUPLOAD.txtimgpath.Text.Trim <> "" Then
            ...
            Dim FILENAME, FILEPATH, DATECOL, CHQCOL, DRAMTCOL, CRAMTCOL, SHEETNAME As String
            ...
            DRAMTCOL = OBJUPLOAD.TXTDRAMTCOL.Text.Trim
            CRAMTCOL = OBJUPLOAD.TXTDRAMTCOL.Text.Trim
            ...
            For I As Integer = STARTROW To ENDROW
                ...
                If IsDBNull(oSheet.Range(DRAMTCOL.ToString & I.ToString).Text) = False Then
                    DTROW("AMOUNT") = oSheet.Range(DRAMTCOL.ToString & I.ToString).Value
                ElseIf IsDBNull(oSheet.Range(CRAMTCOL.ToString & I.ToString).Text) = False Then
                    DTROW("AMOUNT") = oSheet.Range(CRAMTCOL.ToString & I.ToString).Value
                Else
                    DTROW("AMOUNT") = ""
                End If

                If IsDBNull(oSheet.Range(DATECOL.ToString & I.ToString).Value) = False Then
                    DTROW("DATE") = Format(Convert.ToDateTime(oSheet.Range(DATECOL.ToString & I.ToString).Value).Date, "dd/MM/yyyy")
                ...
                For Each ROW As System.Data.DataRow In DT.Rows
                    For Each DTNEWROW As DataRow In DTNEW.Rows
                        If ROW("CHQNO") = DTNEWROW("ChqNo") And (Val(ROW("AMOUNT")) = Val(DTNEWROW("dr")) Or Val(ROW("AMOUNT")) = Val(DTNEWROW("cr"))) Then
                            ...
                            DTNEWROW("RecoDate") = Format(Convert.ToDateTime(ROW("DATE")).Date, "dd/MM/yyyy")
                            'DTNEWROW("RecoDate") = Format(Convert.ToDateTime(ROW("DATE")).Date, "dd/MM/yyyy")
                        End If
                    Next
                Next
