...
LINE1:
    ...
    Sub PRINTREPORT(ByVal SALNO As Integer)
        Try
            ...
            OBJSAL.MdiParent = MDIMain
            OBJSAL.SALNO = SALNO
            OBJSAL.WHERECLAUSE = "{SALARYMASTER.SAL_NO} =" & Val(SALNO) & " AND {SALARYMASTER.SAL_YEARID} = " & YearId
    ...
    Private Sub CMBNAME_Validating(sender As Object, e As CancelEventArgs) Handles CMBNAME.Validating
        Try
            If CMBNAME.Text.Trim <> "" Then namevalidate(CMBNAME, CMBACCCODE, e, Me, TXTDEDADD, " AND GROUPMASTER.GROUP_SECONDARY = 'SUNDRY CREDITORS'", "SUNDRY CREDITORS")
        Catch ex As Exception
            Throw ex
        End Try
    End Sub
