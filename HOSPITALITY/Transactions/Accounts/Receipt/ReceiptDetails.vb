    ...
    Private Sub cmbregister_Validating(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles cmbregister.Validating
        Try
            ...
            If cmbregister.Text.Trim.Length > 0 Then
                ...
                Dim clscommon As New ClsCommon
                Dim dt As DataTable
                dt = clscommon.search(" register_id ", "", " RegisterMaster ", " and register_name ='" & cmbregister.Text.Trim & "' and register_type = 'RECEIPT' and register_YEARid = " & YearId)
                If dt.Rows.Count > 0 Then
                    PAYREGID = dt.Rows(0).Item(0)
                    'cmbregister.Enabled = False
                    fillgrid(" and dbo.RECEIPTMASTER.RECEIPT_YEARid=" & YearId & " AND REGISTERMASTER.REGISTER_NAME = '" & cmbregister.Text.Trim & "' order by dbo.RECEIPTMASTER.RECEIPT_no ")
                Else
