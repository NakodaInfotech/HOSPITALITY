...
Public Class ContraEntry
                            ...
                            If J < gridcontra.RowCount Then
                                ...
                                If Val(gridcontra.Item(6, J).Value.ToString) = 0 Then
                                    ...
                                    If gridcontra.Item(0, J).Value.ToString = "Dr" Then
                                        ...
                                        ALPARAVAL.Add(txtremarks.Text.Trim)                    'REGISTER
                                        ALPARAVAL.Add(CmpId)
                                        ALPARAVAL.Add(Locationid)
                                        ALPARAVAL.Add(Userid)
                                        ALPARAVAL.Add(YearId)
    ...
    Private Function errorvalid() As Boolean
        ...
        If ClientName = "CLASSIC" Then
            If UserName <> "Admin" And edit = False Then
                If contradate.Value.Date < Now.Date Then
                    EP.SetError(contradate, "Back Date Entry Not Allowed")
                    bln = False
                End If
            End If
        End If
        ...
        If ClientName = "CLASSIC" Then
            If UserName <> "Admin" And edit = True Then
                If contradate.Value.Date < DDATE.Date Then
                    EP.SetError(contradate, "Back Date Entry Not Allowed")
                    bln = False
                End If
            End If
    ...
    Private Sub cmbname_Enter(ByVal sender As Object, ByVal e As System.EventArgs) Handles cmbname.Enter
        Try
            'OPEN ALL LEDGERS
            If cmbname.Text.Trim = "" Then fillledger(cmbname, edit, " AND (GROUPMASTER.GROUP_SECONDARY = 'CASH IN HAND' OR GROUPMASTER.GROUP_SECONDARY ='BANK A/C' OR GROUPMASTER.GROUP_SECONDARY ='BANK OD A/C') and acc_cmpid = " & CmpId & " AND ACC_LOCATIONID = " & Locationid & " AND ACC_YEARID = " & YearId)
        Catch ex As Exception
            Throw ex
        End Try
    End Sub
    ...
    Private Sub cmbname_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cmbname.KeyDown
        Try
            ...
            If e.KeyCode = Keys.F1 Then
                ...
                OBJLEDGER.STRSEARCH = " AND (GROUPMASTER.GROUP_SECONDARY = 'CASH IN HAND' OR GROUPMASTER.GROUP_SECONDARY ='BANK A/C' OR GROUPMASTER.GROUP_SECONDARY ='BANK OD A/C') and acc_cmpid = " & CmpId & " AND ACC_LOCATIONID = " & Locationid & " AND ACC_YEARID = " & YearId
    ...
    Private Sub cmbname_Validating(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles cmbname.Validating
        Try
            If cmbname.Text.Trim <> "" Then namevalidate(cmbname, CMBCODE, e, Me, TXTADD, " AND (GROUPMASTER.GROUP_SECONDARY = 'CASH IN HAND' OR GROUPMASTER.GROUP_SECONDARY ='BANK A/C' OR GROUPMASTER.GROUP_SECONDARY ='BANK OD A/C') and acc_cmpid = " & CmpId & " AND ACC_LOCATIONID = " & Locationid & " AND ACC_YEARID = " & YearId)
        Catch ex As Exception
            Throw ex
        End Try
    End Sub
