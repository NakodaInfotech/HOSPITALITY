...
Public Class LedgerMonthly
    ...
    Private Sub cmbname_Validating(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles cmbname.Validating
        Try
            If cmbname.Text.Trim <> "" Then namevalidate(cmbname, CMBACCCODE, e, Me, txtadd, " AND ACC_CMPID = " & CmpId & " AND ACC_LOCATIONID = " & Locationid & " AND ACC_YEARID = " & YearId)
            fillgrid()
        Catch ex As Exception
            Throw ex
        End Try
    ...
    Sub showform()
        Try
            ...
            OBJLEDGER.TEMPNAME = cmbname.Text.Trim
