...
Public Class LedgerSummary
    ...
    Sub fillgrid(ByVal WHERECLAUSE As String)
        ...
        If chkdate.CheckState = CheckState.Checked Then WHERECLAUSE = WHERECLAUSE & " AND REGISTER.acc_billdate >= '" & Format(dtfrom.Value.Date, "MM/dd/yyyy") & "' AND REGISTER.acc_billdate <= '" & Format(dtto.Value.Date, "MM/dd/yyyy") & "'"
    ...
    Private Sub LedgerSummary_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyDown
        Try
            If e.KeyCode = Windows.Forms.Keys.Escape Or (e.KeyCode = Keys.X And e.Alt = True) Then
                Me.Close()
            ElseIf (e.KeyCode = Keys.O And e.Alt = True ) OR e.KeyCode = Keys.Enter Then
