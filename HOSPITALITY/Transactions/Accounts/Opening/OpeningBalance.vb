...
Public Class OpeningBalance
    ...
    Sub fillgrid(ByVal TEMPCONDITION As String)
        Try
            ...
            TEMPCONDITION = TEMPCONDITION & " and dbo.LEDGERS.ACC_cmpid=" & CmpId & " and LEDGERS.ACC_locationid = " & Locationid & " and LEDGERS.ACC_yearid = " & YearId & " ORDER BY LEDGERS.ACC_CMPNAME "
        ...
        Try
            ...
            For i As Integer = 0 To gridledger.RowCount - 1
                ...
                Else
                    ...
                    DEBIT = DEBIT & "|" & (dtrow("DEBIT"))
                    CREDIT = CREDIT & "|" & (dtrow("CREDIT"))
                End If
            Next
