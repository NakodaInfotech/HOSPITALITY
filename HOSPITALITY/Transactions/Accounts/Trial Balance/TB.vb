        ...
        Try
            ...
            Else
                ...
                If DT.Rows.Count > 0 Then
                    For Each DTROW As DataRow In DT.Rows
                        If IsDBNull(DTROW("NAME")) = False Then
...
#End Region
    ...
    Private Sub cmdok_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdok.Click
        Try
            If tabop.Visible = False Then
                If gridtrialbalance.CurrentRow.Cells(GNAME.Index).Value <> Nothing Then showform(gridtrialbalance.CurrentRow.Cells(GNAME.Index).Value.ToString.Trim)
            Else
                If gridopclo.CurrentRow.Cells(0).Value <> Nothing Then showform(gridopclo.CurrentRow.Cells(0).Value.ToString.Trim)
            End If
        Catch ex As Exception
            Throw ex
        End Try
    ...
    Sub showform(ByVal name As String)
        Try
            ...
            '''''''DONE BY NEHA AS ERROR WAS COMING ON DOUBLECLICK......
            If name <> "" Then
