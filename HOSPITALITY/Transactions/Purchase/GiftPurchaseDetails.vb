...
Public Class GiftPurchaseDetails

    Dim PURCHASEREGID As Integer
    Dim USERADD, USEREDIT, USERVIEW, USERDELETE As Boolean      'USED FOR RIGHT MANAGEMAENT

    Private Sub GiftPurchaseDetails_KeyDown(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
        Try
    ...
    Sub fillgrid(ByVal tepmcondition)
        Try
            ...
            Dim dt As DataTable
            dt = objclsCMST.search("  GIFTPURCHASEMASTER.BILL_NO AS SRNO, GIFTPURCHASEMASTER.BILL_DATE AS DATE, LEDGERS.Acc_cmpname AS NAME, ISNULL(GIFTPURCHASEMASTER.BILL_PARTYBILLNO, '') AS PARTYBILLNO, GIFTPURCHASEMASTER.BILL_PARTYBILLDATE AS PARTYDATE, ISNULL(GIFTPURCHASEMASTER.BILL_TOTALQTY, 0) AS TOTALQTY,GIFTPURCHASEMASTER.BILL_GRANDTOTAL AS GRANDTOTAL, ISNULL(GIFTPURCHASEMASTER.BILL_REMARKS, '') AS REMARKS, ISNULL(GIFTPURCHASEMASTER.BILL_DISPUTE, 0) AS DISPUTED, ISNULL(GIFTPURCHASEMASTER.BILL_CHECKED, 0) AS CHECKED,ISNULL(GIFTPURCHASEMASTER.BILL_RETURN, 0) AS PURRETURN", " ", "  GIFTPURCHASEMASTER INNER JOIN LEDGERS ON GIFTPURCHASEMASTER.BILL_LEDGERID = LEDGERS.Acc_id AND GIFTPURCHASEMASTER.BILL_YEARID = LEDGERS.Acc_yearid INNER JOIN REGISTERMASTER ON GIFTPURCHASEMASTER.BILL_REGISTERID = REGISTERMASTER.register_id AND GIFTPURCHASEMASTER.BILL_YEARID = REGISTERMASTER.register_yearid", tepmcondition)
    ...
    Sub showform(ByVal editval As Boolean, ByVal billno As Integer)
        Try
            ...
            If (editval = False) Or (editval = True And gridbill.RowCount > 0) Then
                Dim OBJBILL As New GiftPurchase
        ...
        Try
            ...
            If cmbregister.Text.Trim.Length > 0 Then
                ...
                If dt.Rows.Count > 0 Then
                    ...
                    fillgrid(" AND GIFTPURCHASEMASTER.BILL_yearid = " & YearId & " AND GIFTPURCHASEMASTER.BILL_registerid = " & PURCHASEREGID & " order by dbo.GIFTPURCHASEMASTER.BILL_no ")
                Else
    ...
    Private Sub GiftPurchaseDetails_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            Dim DTROW() As DataRow
    ...
    Private Sub GiftPurchaseDetails_Shown(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Shown
