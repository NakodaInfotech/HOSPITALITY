...
Public Class GuestDetails
    ...
    Private Sub GuestDetails_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyDown
    ...
    Private Sub GuestDetails_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
    ...
    Sub getdetails(ByRef name As String)
        ...
        Dim dttable As New DataTable
        Dim OBJGUEST As New ClsGuestMaster
        OBJGUEST.alParaval.Add(name)
        OBJGUEST.alParaval.Add(CmpId)
        OBJGUEST.alParaval.Add(Locationid)
        OBJGUEST.alParaval.Add(YearId)
        dttable = OBJGUEST.SELECTGUESTDETAILS
    ...
    Private Sub PBEXCEL_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles PBEXCEL.Click
        Try
            ...
            Dim OBJGUEST As New GuestLedgerDetails
            OBJGUEST.MdiParent = MDIMain
            OBJGUEST.Show()
            Me.Close()
        Catch ex As Exception
