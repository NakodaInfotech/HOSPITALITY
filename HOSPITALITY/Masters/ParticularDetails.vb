...
Public Class ParticularDetails
    ...
    Sub fillgrid()
        ...
        dttable = objClsCommon.search(" particular_name, particular_id", "", "PARTICULARMASTER", " and particular_cmpid = " & CmpId & " and particular_locationid = " & Locationid & " and particular_yearid = " & YearId)
    ...
    Sub showform(ByVal editval As Boolean, ByVal name As String, ByVal id As Integer)
        Try
            Dim objCategorymaster As New ParticularMaster
