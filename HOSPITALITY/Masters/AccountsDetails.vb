...
Public Class AccountsDetails
    ...
    Sub getdetails(ByRef name As String)
        ...
        If dttable.Rows.Count > 0 Then
            ...
            txtarea.Text = dttable.Rows(0).Item(8).ToString
            txtcity.Text = dttable.Rows(0).Item(9).ToString
            txtzipcode.Text = dttable.Rows(0).Item(11).ToString
            txtstate.Text = dttable.Rows(0).Item(10).ToString

            txtcountry.Text = dttable.Rows(0).Item(12).ToString
            ...
            txtemail.Text = dttable.Rows(0).Item(20).ToString
    ...
    Private Sub gridledger_RowStyle(ByVal sender As Object, ByVal e As DevExpress.XtraGrid.Views.Grid.RowStyleEventArgs) Handles gridledger.RowStyle
        Try
            If e.RowHandle >= 0 Then
                ...
                If View.GetRowCellDisplayText(e.RowHandle, View.Columns("LOCKED")) = "Checked" Then
