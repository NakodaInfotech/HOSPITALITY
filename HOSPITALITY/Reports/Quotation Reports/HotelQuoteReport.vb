...
Public Class HotelQuoteReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HOSPITALITY.HotelQuoteReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedHotelQuoteReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As HotelQuoteReport = New HotelQuoteReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
