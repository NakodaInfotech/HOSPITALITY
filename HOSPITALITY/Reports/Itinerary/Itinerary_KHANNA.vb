...
Public Class Itinerary_KHANNA
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HOSPITALITY.Itinerary_KHANNA.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedItinerary_KHANNA
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Itinerary_KHANNA = New Itinerary_KHANNA()
        rpt.Site = Me.Site
        Return rpt
    End Function
