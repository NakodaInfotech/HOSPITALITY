...
Public Class Itinerary_VIHAR
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HOSPITALITY.Itinerary_VIHAR.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedItinerary_VIHAR
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Itinerary_VIHAR = New Itinerary_VIHAR()
        rpt.Site = Me.Site
        Return rpt
    End Function
