...
Public Class Itinerary_REPORT
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HOSPITALITY.Itinerary_REPORT.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedItinerary_REPORT
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Itinerary_REPORT = New Itinerary_REPORT()
        rpt.Site = Me.Site
        Return rpt
    End Function
