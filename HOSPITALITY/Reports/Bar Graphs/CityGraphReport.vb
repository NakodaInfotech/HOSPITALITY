...
Public Class CityGraphReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HOSPITALITY.CityGraphReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCityGraphReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CityGraphReport = New CityGraphReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
