...
Public Class PassportPhoto_Guest
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "PassportPhoto_Guest.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HOSPITALITY.PassportPhoto_Guest.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPassportPhoto_Guest
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PassportPhoto_Guest = New PassportPhoto_Guest()
        rpt.Site = Me.Site
        Return rpt
    End Function
