...
Public Class AirlineBookingInvoice_URMI
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "AirlineBookingInvoice_URMI.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HOSPITALITY.AirlineBookingInvoice_URMI.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedAirlineBookingInvoice_URMI
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As AirlineBookingInvoice_URMI = New AirlineBookingInvoice_URMI()
        rpt.Site = Me.Site
        Return rpt
    End Function
