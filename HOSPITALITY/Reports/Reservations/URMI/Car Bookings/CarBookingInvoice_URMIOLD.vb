...
Public Class CarBookingInvoice_URMIOLD
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "CarBookingInvoice_URMIOLD.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HOSPITALITY.CarBookingInvoice_URMIOLD.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCarBookingInvoice_URMIOLD
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CarBookingInvoice_URMIOLD = New CarBookingInvoice_URMIOLD()
        rpt.Site = Me.Site
        Return rpt
    End Function
