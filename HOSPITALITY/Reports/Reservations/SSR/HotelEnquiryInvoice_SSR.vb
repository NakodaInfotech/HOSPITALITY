...
Public Class HotelEnquiryInvoice_SSR
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "HotelEnquiryInvoice_SSR.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HOSPITALITY.HotelEnquiryInvoice_SSR.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedHotelEnquiryInvoice_SSR
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As HotelEnquiryInvoice_SSR = New HotelEnquiryInvoice_SSR()
        rpt.Site = Me.Site
        Return rpt
    End Function
