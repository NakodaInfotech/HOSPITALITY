...
Public Class CarBookingInvoice_SSROLD
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "CarBookingInvoice_SSROLD.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HOSPITALITY.CarBookingInvoice_SSROLD.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCarBookingInvoice_SSROLD
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CarBookingInvoice_SSROLD = New CarBookingInvoice_SSROLD()
        rpt.Site = Me.Site
        Return rpt
    End Function
