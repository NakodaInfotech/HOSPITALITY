...
Public Class AirlineBookingInvoice_SSR
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "AirlineBookingInvoice_SSR.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HOSPITALITY.AirlineBookingInvoice_SSR.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedAirlineBookingInvoice_SSR
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As AirlineBookingInvoice_SSR = New AirlineBookingInvoice_SSR()
        rpt.Site = Me.Site
        Return rpt
    End Function
