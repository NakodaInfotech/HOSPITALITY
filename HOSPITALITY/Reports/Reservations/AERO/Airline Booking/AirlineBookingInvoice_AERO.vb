...
Public Class AirlineBookingInvoice_AERO
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "AirlineBookingInvoice_AERO.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HOSPITALITY.AirlineBookingInvoice_AERO.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedAirlineBookingInvoice_AERO
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As AirlineBookingInvoice_AERO = New AirlineBookingInvoice_AERO()
        rpt.Site = Me.Site
        Return rpt
    End Function
