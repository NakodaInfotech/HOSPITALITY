...
Public Class HolidayPackageInvoice_OLD
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "HolidayPackageInvoice_OLD.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HOSPITALITY.HolidayPackageInvoice_OLD.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedHolidayPackageInvoice_OLD
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As HolidayPackageInvoice_OLD = New HolidayPackageInvoice_OLD()
        rpt.Site = Me.Site
        Return rpt
    End Function
