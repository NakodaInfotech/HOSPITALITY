...
Public Class InternationalVoucher
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "InternationalVoucher.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HOSPITALITY.InternationalVoucher.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedInternationalVoucher
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As InternationalVoucher = New InternationalVoucher()
        rpt.Site = Me.Site
        Return rpt
    End Function
