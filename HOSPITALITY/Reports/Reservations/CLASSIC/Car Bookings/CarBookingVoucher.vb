...
Public Class CarBookingVoucher
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HOSPITALITY.CarBookingVoucher.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCarBookingVoucher
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CarBookingVoucher = New CarBookingVoucher()
        rpt.Site = Me.Site
        Return rpt
    End Function
