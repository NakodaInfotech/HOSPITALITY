...
Public Class PackageBookingVoucher_KPNT
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "PackageBookingVoucher_KPNT.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HOSPITALITY.PackageBookingVoucher_KPNT.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPackageBookingVoucher_KPNT
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PackageBookingVoucher_KPNT = New PackageBookingVoucher_KPNT()
        rpt.Site = Me.Site
        Return rpt
    End Function
