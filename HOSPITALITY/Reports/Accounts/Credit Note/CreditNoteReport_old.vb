...
Public Class CreditNoteReport_old
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "CreditNoteReport_old.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HOSPITALITY.CreditNoteReport_old.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCreditNoteReport_old
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CreditNoteReport_old = New CreditNoteReport_old()
        rpt.Site = Me.Site
        Return rpt
    End Function
