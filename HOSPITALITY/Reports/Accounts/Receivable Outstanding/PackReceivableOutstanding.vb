...
Public Class PackReceivableOutstanding
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "PackReceivableOutstanding.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HOSPITALITY.PackReceivableOutstanding.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPackReceivableOutstanding
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PackReceivableOutstanding = New PackReceivableOutstanding()
        rpt.Site = Me.Site
        Return rpt
    End Function
