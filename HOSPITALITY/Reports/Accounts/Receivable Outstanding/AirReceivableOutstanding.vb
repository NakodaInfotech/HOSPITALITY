...
Public Class AirReceivableOutstanding
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "AirReceivableOutstanding.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HOSPITALITY.AirReceivableOutstanding.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedAirReceivableOutstanding
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As AirReceivableOutstanding = New AirReceivableOutstanding()
        rpt.Site = Me.Site
        Return rpt
    End Function
