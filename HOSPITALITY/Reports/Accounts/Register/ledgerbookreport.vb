...
Public Class ledgerbookreport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HOSPITALITY.ledgerbookreport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedledgerbookreport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ledgerbookreport = New ledgerbookreport()
        rpt.Site = Me.Site
        Return rpt
    End Function
