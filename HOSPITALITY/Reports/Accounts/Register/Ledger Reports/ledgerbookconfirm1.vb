...
Public Class ledgerbookconfirm
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HOSPITALITY.ledgerbookconfirm.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedledgerbookconfirm
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ledgerbookconfirm = New ledgerbookconfirm()
        rpt.Site = Me.Site
        Return rpt
    End Function
