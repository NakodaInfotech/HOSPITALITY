...
Public Class ChqPayment_GLOBE
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HOSPITALITY.ChqPayment_GLOBE.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedChqPayment_GLOBE
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ChqPayment_GLOBE = New ChqPayment_GLOBE()
        rpt.Site = Me.Site
        Return rpt
    End Function
