...
Public Class ChqPayment_WS_2
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HOSPITALITY.ChqPayment_WS (2).rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedChqPayment_WS_2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ChqPayment_WS_2 = New ChqPayment_WS_2()
        rpt.Site = Me.Site
        Return rpt
    End Function
