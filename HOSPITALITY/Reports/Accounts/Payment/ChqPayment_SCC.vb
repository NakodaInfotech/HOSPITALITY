...
Public Class ChqPayment_SCC
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HOSPITALITY.ChqPayment_SCC.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedChqPayment_SCC
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ChqPayment_SCC = New ChqPayment_SCC()
        rpt.Site = Me.Site
        Return rpt
    End Function
