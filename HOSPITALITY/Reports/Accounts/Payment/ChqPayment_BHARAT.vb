...
Public Class ChqPayment_BHARAT
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HOSPITALITY.ChqPayment_BHARAT.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedChqPayment_BHARAT
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ChqPayment_BHARAT = New ChqPayment_BHARAT()
        rpt.Site = Me.Site
        Return rpt
    End Function
