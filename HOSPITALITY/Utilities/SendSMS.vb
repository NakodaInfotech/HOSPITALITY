...
Public Class SendSMS
    ...
    Private Sub cmdok_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdok.Click
        Try
            ...
            If ALLOWSMS = True Then
                If SENDMSG(txtmailbody.Text.Trim, txtmobileno.Text.Trim, CMBGUESTCATEGORY.Text.Trim, CMBGROUPDEPARTURE.Text.Trim) = "1701" Then
                    MsgBox("Message Sent")
    ...
    Function errorvalid() As Boolean
        ...
        If RBGUEST.Checked = True Then
            ...
            Next
        End If
        If txtmobileno.Text.Trim.Length = 0 And CMBGUESTCATEGORY.Text.Trim = "" And CMBGROUPDEPARTURE.Text.Trim = "" Then
            EP.SetError(txtmobileno, "Enter Email Address")
            bln = False
        End If
    ...
    Private Sub SendSMS_Shown(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Shown
