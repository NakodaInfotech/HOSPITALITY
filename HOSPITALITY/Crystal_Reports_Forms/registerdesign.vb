...
Public Class registerdesign
    ...
    Dim RPTLBALL As New LedgerBookReport_All
    Dim rptlb As New ledgerbookreport
    Dim rptlbd As New ledgerbookdetailreport
    ...
    'REPORTS CHECKED BY GULKIT
    Dim RPTLEDGERCONF As New LedgerBookConfirmationReport
    Dim RPTLEDGERCONFSUMM As New LedgerBookConfirmationReport_Summ
    ...
    Public MULTICOMPANY As Integer = 0
    ...
    Private Sub CRPO_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles CRPO.Load
        Try
            ...
            ElseIf frmstring = "SaleRegister" Or frmstring = "SaleRegisterDetails" Then
                ...
                End If
            ElseIf frmstring = "LedgerBook" Or frmstring = "LedgerBookDetails" Or frmstring = "LedgerBookConfirm" Or frmstring = "LedgerBookTFormat" Or frmstring = "LedgerBookAll" Or frmstring = "LedgerBookConfirmSumm" Then
                ...
                ElseIf frmstring = "LedgerBookAll" Then
                    crTables = RPTLBALL.Database.Tables
                ...
                ElseIf frmstring = "LedgerBookConfirm" Then
                    crTables = RPTLEDGERCONF.Database.Tables
                ElseIf frmstring = "LedgerBookConfirmSumm" Then
                    crTables = RPTLEDGERCONFSUMM.Database.Tables
                End If
            ...
            If frmstring = "LABEL" Then
                CRPO.ReportSource = RPTLABEL
                CRPO.SelectionFormula = strsearch
            ElseIf frmstring = "CashRegister" Or frmstring = "BankRegister" Or frmstring = "BankBookDetails" Then
                If frmstring = "CashRegister" Then
                ...
                ElseIf frmstring = "BankBookDetails" Then
                    strsearch = strsearch & " {REPORT_SP_BANKBOOK_DETAILS.Name}='" & Name & "'"
            ...
            ElseIf frmstring = "LedgerBook" Or frmstring = "LedgerBookDetails" Or frmstring = "LedgerBookConfirm" Or frmstring = "LedgerBookTFormat" Or frmstring = "LedgerBookAll" Or frmstring = "LedgerBookConfirmSumm" Then
                ...
                If frmstring = "LedgerBook" Then
                    ...
                    RPTLEDGERAC.DataDefinition.FormulaFields("MULTICOMPANY").Text = MULTICOMPANY
                ...
                ElseIf frmstring = "LedgerBookAll" Then
                    'rptlb.DataDefinition.FormulaFields("openingdrcr").Text = "'" & crdr & "'"
                    'rptlb.DataDefinition.FormulaFields("NEWCLOSING").Text = "'" & CLOSINGAMT & " " & CLOSINGDRCR & "'"

                    'strsearch = strsearch & " {LEDGERBOOK.LEDGERNAME}='Aarti Travels'" '" & name & "'"
                    'strsearch = strsearch & " and {@DATE} in date " & fromD & " to date " & toD

                    crParameterFieldDefinitions = RPTLBALL.DataDefinition.ParameterFields
                    crParameterDiscreteValue.Value = Format(FROMDATE.Date, "dd/MM/yyyy")
                    crParameterFieldDefinition = crParameterFieldDefinitions.Item("FDATE")
                    crParameterValues.Clear()
                    crParameterValues = crParameterFieldDefinition.CurrentValues
                    crParameterValues.Add(crParameterDiscreteValue)
                    crParameterFieldDefinition.ApplyCurrentValues(crParameterValues)
                    ...
                    crParameterFieldDefinitions1 = RPTLBALL.Subreports("OPENINGBALANCE").DataDefinition.ParameterFields
                    crParameterDiscreteValue1.Value = Format(FROMDATE.Date, "dd/MM/yyyy")
                    crParameterFieldDefinition1 = crParameterFieldDefinitions.Item("FOPDATE")
                    ...
                    RPTLBALL.GroupFooterSection1.SectionFormat.EnableNewPageAfter = NEWPAGE
                    RPTLBALL.DataDefinition.FormulaFields("FROMDATE").Text = Format(FROMDATE.Date, "dd/MM/yyyy")
                    'strsearch = strsearch & " and ({@DATE} in date " & fromD & " to date " & toD & ")"
                    strsearch = strsearch & "  and {LEDGERBOOK.CMPID}=" & CmpId & " and {LEDGERBOOK.LOCATIONID}=" & Locationid & " and {LEDGERBOOK.YEARID}=" & YearId
                    CRPO.SelectionFormula = strsearch
                    CRPO.ReportSource = RPTLBALL
                ...
                ElseIf frmstring = "LedgerBookConfirm" Then
                    ...
                    strsearch = " {LEDGERBOOK.name}='" & Name & "' and {LEDGERBOOK.YEARID}=" & YearId
                    RPTLEDGERCONF.DataDefinition.FormulaFields("PERIOD").Text = "'" & PERIOD & "'"
                    RPTLEDGERCONF.DataDefinition.FormulaFields("FROMDATE").Text = "'" & Format(Convert.ToDateTime(FROMDATE).Date, "MM/dd/yyyy") & "'"
                    RPTLEDGERCONF.DataDefinition.FormulaFields("TODATE").Text = "'" & Format(Convert.ToDateTime(TODATE).Date, "MM/dd/yyyy") & "'"

                    RPTLEDGERCONF.GroupFooterSection4.SectionFormat.EnableNewPageAfter = NEWPAGE

                    CRPO.SelectionFormula = strsearch
                    CRPO.ReportSource = RPTLEDGERCONF

                ElseIf frmstring = "LedgerBookConfirmSumm" Then
                    RPTLEDGERCONFSUMM.DataDefinition.FormulaFields("PERIOD").Text = "'" & PERIOD & "'"
                    RPTLEDGERCONFSUMM.DataDefinition.FormulaFields("FROMDATE").Text = "'" & Format(Convert.ToDateTime(FROMDATE).Date, "MM/dd/yyyy") & "'"
                    RPTLEDGERCONFSUMM.DataDefinition.FormulaFields("TODATE").Text = "'" & Format(Convert.ToDateTime(TODATE).Date, "MM/dd/yyyy") & "'"

                    RPTLEDGERCONFSUMM.GroupFooterSection4.SectionFormat.EnableNewPageAfter = NEWPAGE

                    CRPO.SelectionFormula = strsearch
                    CRPO.ReportSource = RPTLEDGERCONFSUMM
                End If
    ...
    Sub Transfer()
        Try
            ...
            ElseIf frmstring = "LedgerBookConfirm" Then
                oDfDopt.DiskFileName = Application.StartupPath & "\LEDGERBOOK.PDF"
                expo = RPTLEDGERCONF.ExportOptions
                expo.ExportDestinationType = ExportDestinationType.DiskFile
                expo.ExportFormatType = ExportFormatType.PortableDocFormat
                expo.DestinationOptions = oDfDopt
                RPTLEDGERCONF.Export()

            ElseIf frmstring = "LedgerBookConfirmSumm" Then
                oDfDopt.DiskFileName = Application.StartupPath & "\LEDGERBOOK.PDF"
                expo = RPTLEDGERCONFSUMM.ExportOptions
                expo.ExportDestinationType = ExportDestinationType.DiskFile
                expo.ExportFormatType = ExportFormatType.PortableDocFormat
                expo.DestinationOptions = oDfDopt
                RPTLEDGERCONFSUMM.Export()
    ...
    Private Sub registerdesign_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyDown
