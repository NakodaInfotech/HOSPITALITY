...
Public Class filter
    ...
    Sub fillgrid()
        ...
        Try
            ...
            Dim dt As DataTable
            If frmstring = "purchasedetails" Or frmstring = "purchasesummary" Or frmstring = "PaymentDetails" Or frmstring = "AdvancesPaidReport" Or frmstring = "PAYMENTBILLWISE" Then
            ...
            ElseIf frmstring = "saledetails" Or frmstring = "salesummary" Or frmstring = "ReceiptDetails" Or frmstring = "AdvancesReceiveReport" Or frmstring = "RECEIPTBILLWISE" Then
                dt = objclspo.search("    dbo.LEDGERS.Acc_cmpname as [NAME], dbo.LEDGERS.Acc_id ", "", "     dbo.LEDGERS INNER JOIN dbo.GROUPMASTER ON dbo.LEDGERS.Acc_groupid = dbo.GROUPMASTER.group_id AND dbo.LEDGERS.Acc_locationid = dbo.GROUPMASTER.group_locationid And dbo.LEDGERS.Acc_cmpid = dbo.GROUPMASTER.group_cmpid And dbo.LEDGERS.Acc_YEARid = dbo.GROUPMASTER.group_YEARid", " and acc_cmpid = " & CmpId & " and acc_LOCATIONid = " & Locationid & " and acc_YEARid = " & YearId & "  order by dbo.LEDGERS.Acc_cmpname")
    ...
    Private Sub cmbregister_Enter(ByVal sender As Object, ByVal e As System.EventArgs) Handles cmbregister.Enter
        Try
            ...
            Dim dt As DataTable
            If frmstring = "purchasedetails" Or frmstring = "purchasesummary" Then
            ...
            ElseIf frmstring = "saledetails" Or frmstring = "salesummary" Then
            ...
            ElseIf frmstring = "PaymentDetails" Or frmstring = "AdvancesPaidReport" Or frmstring = "PAYMENTBILLWISE" Then
            ...
            ElseIf frmstring = "ReceiptDetails" Or frmstring = "AdvancesReceiveReport" Or frmstring = "RECEIPTBILLWISE" Then
    ...
    Private Sub cmdShowReport_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdShowReport.Click
        Try
            ...
            If frmstring = "PaymentDetails" Or frmstring = "AdvancesPaidReport" Or frmstring = "AdvancesReceiveReport" Or frmstring = "ReceiptDetails" Then
                ...
                If frmstring = "PaymentDetails" Then
                    ...
                    If chkdate.Checked = True Then
                        ...
                        If objadv_rec_dtls.strsearch <> "" Then
                            ...
                            objadv_rec_dtls.PERIOD = Format(dtfrom.Value.Date, "dd/MM/yyyy") & " - " & Format(dtto.Value.Date, "dd/MM/yyyy")
                        Else
                            objadv_rec_dtls.strsearch = objadv_rec_dtls.strsearch & "  {@PAYMENTDATE} in date " & fromD & " to date " & toD & ""
                            objadv_rec_dtls.PERIOD = Format(AccFrom.Date, "dd/MM/yyyy") & " - " & Format(AccTo.Date, "dd/MM/yyyy")
                        End If
                    End If
            ...
            ElseIf frmstring = "Contra-PartyWise" Then
                ...
                Dim objcontra As New Journal_Contra_Details
                objcontra.y = "Open-ContraPartyReport"
                objcontra.strsearch = ""
            ...
            ElseIf frmstring = "Journal-PartyWise" Then
                ...
                Dim objjournal As New Journal_Contra_Details
                objjournal.y = "Open-JournalPartyReport"
