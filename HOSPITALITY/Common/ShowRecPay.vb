        ...
        Try
            For Each ROW As DataGridViewRow In GRIDRECPAY.SelectedRows
                ...
                ElseIf ROW.Cells(4).Value.ToString = "RECEIPT" Then
                    ...
                    OBJREC.Show()
                ElseIf ROW.Cells(4).Value.ToString = "MATCHING" Then

                    Dim OBJMATCH As New Matching
                    OBJMATCH.MdiParent = MDIMain
                    OBJMATCH.edit = True
                    OBJMATCH.TEMPMATCHNO = ROW.Cells(2).Value.ToString
                    OBJMATCH.Show()
                ...
                ElseIf ROW.Cells(4).Value.ToString = "AIRDEBITNOTE" Then
                    ...
                    OBJDN.TEMPREGNAME = ROW.Cells(3).Value.ToString
                    OBJDN.Show()
                ElseIf ROW.Cells(4).Value.ToString = "AIRCREDITNOTE" Then
